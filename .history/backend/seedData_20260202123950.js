...
const movies = [
    ...
    },
    {
        ...
        description: 'Paul Atreides leads his Fremen army across the universe to challenge the corrupt Emperor. The fate of all humanity hangs in the balance.',
    ...
    {
        title: 'The Matrix 5: Awakening',
        description: 'Neo discovers a new layer of the Matrix that threatens to collapse both the digital and real worlds. A new generation of rebels must rise.',
    ...
    },
    {
        ...
        description: 'Dom Toretto faces his most dangerous enemy from the past. Family is put to the ultimate test in this explosive finale.',
        genre: ['Action', 'Thriller', 'Crime'],
        duration: 145,
    ...
    },
    {
        ...
        description: 'The Guardians embark on their most personal mission yet as Rocket confronts his creator. The galaxy needs saving one more time.',
    ...
    },
    {
        ...
        description: 'Jake Sully and Neytiri must explore new regions of Pandora as a new threat emerges from the depths of the ocean.',
    ...
    },
    {
        ...
        description: 'Dinosaurs now roam freely across the world. Humanity must learn to coexist or face extinction themselves.',
    ...
    },
    {
        ...
        description: 'Wakanda faces its greatest challenge as ancient enemies resurface. Shuri must embrace her destiny to protect her nation.',
        genre: ['Action', 'Adventure', 'Sci-Fi'],
        duration: 165,
    ...
    },
    {
        ...
        description: 'Ethan Hunt races against time to stop a rogue AI that threatens global security. His most impossible mission yet.',
    ...
    {
        title: 'Oppenheimer 2: Fallout',
        description: 'The aftermath of the atomic bomb and the Cold War tensions that followed. A gripping historical drama about consequences.',
